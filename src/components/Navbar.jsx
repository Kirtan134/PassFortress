  ...
  return (
    <nav className="bg-slate-100  text-black ">
      <div className="mycontainer flex justify-between items-center px-4 py-5 h-14  -z-10 ">
        ...
        <a href="https://github.com/Kirtan134/PassFortress" target="_blank" rel="noopener noreferrer" className="text-white bg-black my-5 rounded-full flex justify-between items-center ring-white ring-1">
